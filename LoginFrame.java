...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        setTitle("Login");
        setSize(350, 250); // Adjusted window size
        ...
        usernameField.setBounds(120, 50, 160, 25); // Adjusted field size
        ...
        passwordField.setBounds(120, 90, 160, 25); // Adjusted field size
        passwordField.setFont(new Font("Arial", Font.PLAIN, 14));
        panel.add(passwordField);

        // Login Button
        loginButton = new JButton("Login");
        loginButton.setBounds(120, 130, 100, 30); // Adjusted button size
